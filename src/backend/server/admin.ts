...
// --- Plugin Management API (ported from openlistnext, API-compatible) ---
...
adminRouter.post("/plugin/install", async (c) => {
  try {
    ...
    return c.json({
      code: 500,
      message: safeErrorMessage(err, "Failed to install plugin"),
      data: null,
    })
  }
})
...
adminRouter.post("/plugin/update", async (c) => {
  try {
    ...
    return c.json({
      code: 500,
      message: safeErrorMessage(err, "Failed to update plugin"),
      data: null,
    })
  }
})
...
adminRouter.post("/plugin/toggle", async (c) => {
  try {
    ...
    return c.json({
      code: 500,
      message: safeErrorMessage(err, "Failed to toggle plugin"),
      data: null,
    })
  }
})
...
adminRouter.post("/plugin/delete", async (c) => {
  try {
    ...
    return c.json({
      code: 500,
      message: safeErrorMessage(err, "Failed to delete plugin"),
      data: null,
    })
  }
})
...
adminRouter.post("/plugin/batch_save", async (c) => {
  try {
    ...
    return c.json({
      code: 500,
      message: safeErrorMessage(err, "Failed to batch save plugins"),
      data: null,
    })
  }
})
