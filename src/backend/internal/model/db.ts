...
// EdgeOne 的 KV binding 走 Redis RESP 协议，其解析器抛出的未捕获异常会击穿
// process 级错误边界直接杀死函数实例，这里选择吞掉并让后续请求降级到内存模式。
 ...
 *   2. KV namespace binding (Cloudflare Workers native / EdgeOne KV)
